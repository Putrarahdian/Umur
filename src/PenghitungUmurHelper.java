...
PrabowoWIN, Supplier<Boolean> shouldStop) {
 try {
...
PrabowoWIN.setText("Pengambilan data dibatalkan.\n"));
 ...
 javax.swing.SwingUtilities.invokeLater(() ->
PrabowoWIN.append(peristiwa + "\n"));
 }
 if (events.length() == 0) {
 javax.swing.SwingUtilities.invokeLater(() ->
PrabowoWIN.setText("Tidak ada peristiwa penting yang ditemukan pada tanggal ini."));
 }
 } catch (Exception e) {
 javax.swing.SwingUtilities.invokeLater(() ->
PrabowoWIN.setText("Gagal mendapatkan data peristiwa: " +e.getMessage()));
 }
}
